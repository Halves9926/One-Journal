...
const baseButtonClassName =
  'inline-flex min-w-0 touch-manipulation items-center justify-center gap-2 rounded-full border text-sm font-semibold tracking-tight transition duration-300 ease-out will-change-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent-focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)] disabled:cursor-not-allowed disabled:opacity-60';
...
const variantClassNames: Record<ButtonVariant, string> = {
  primary:
    'border-[color:var(--accent-border-soft)] bg-[linear-gradient(135deg,var(--accent-gradient-start),var(--accent-gradient-mid)_60%,var(--accent-gradient-end))] text-[var(--accent-button-text)] shadow-[0_24px_54px_-24px_var(--accent-button-shadow),inset_0_1px_0_rgba(255,255,255,0.2)] hover:-translate-y-1 hover:shadow-[0_30px_62px_-24px_var(--accent-button-shadow)] active:translate-y-0 active:scale-[0.99]',
  secondary:
